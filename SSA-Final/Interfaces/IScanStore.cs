...
namespace SSA_Final.Interfaces
{
    public interface IScanStore
    {
        ...
        /// <summary>
        /// Returns analyzed domain rows in the given UTC time window, optionally
        /// restricted to domains that were flagged as suspicious.
        /// </summary>
        Task<IReadOnlyList<DomainAnalysisReportItem>> GetAnalyzedDomainReportItemsAsync(
            DateTime startUtc,
            DateTime endUtc,
