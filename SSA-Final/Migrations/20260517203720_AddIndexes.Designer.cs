...
namespace SSA_Final.Migrations
{
    ...
    [Migration("20260517203720_AddIndexes")]
            ...
            modelBuilder.Entity("SSA_Final.Models.DomainAnalysisResult", b =>
                {
                    ...
                    b.HasIndex("IsBlocklistMatch")
                        .HasDatabaseName("IX_DomainAnalysisResults_IsBlocklistMatch");

                    b.HasIndex("IsSuspicious")
                        .HasDatabaseName("IX_DomainAnalysisResults_IsSuspicious");

                    b.HasIndex("RiskClassification")
                        .HasDatabaseName("IX_DomainAnalysisResults_RiskClassification");
            ...
            modelBuilder.Entity("SSA_Final.Models.DomainScan", b =>
                {
                    ...
                    b.HasIndex("BaseDomain")
                        .HasDatabaseName("IX_DomainScans_BaseDomain");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_DomainScans_CreatedAt");

                    b.HasIndex("NumMaliciousDomains")
                        .HasDatabaseName("IX_DomainScans_NumMaliciousDomains");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_DomainScans_Status");
